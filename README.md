...
The encoder checkpoint with full ImageNet 67.694% validation top1 accuracy can be found [here](https://github.com/SsnL/moco_align_uniform/releases/download/v1.0-checkpoints/imagenet_align_uniform.pth).
